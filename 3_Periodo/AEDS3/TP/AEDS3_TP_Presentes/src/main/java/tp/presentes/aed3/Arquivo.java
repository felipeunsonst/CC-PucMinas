...
public class Arquivo<T extends Registro> {
    ...
    public Arquivo(String na, Constructor<T> c) throws Exception {
        File d = new File("./src/main/resources/dados");
        if(!d.exists())
            d.mkdir();

        d = new File("./src/main/resources/dados/"+na);
        if(!d.exists())
            d.mkdir();

        this.nomeArquivo = "./src/main/resources/dados/"+na+"/"+na+".db";
        this.construtor = c;
        ...
        indiceDireto = new HashExtensivel<>(
            ...
            4, 
            "./src/main/resources/dados/"+na+"/"+na+".d.db", // diretório 
            "./src/main/resources/dados/"+na+"/"+na+".c.db"  // cestos
        );
    }
